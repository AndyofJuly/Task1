...
public class DungeonsService {
    ...
    public static ArrayList<Integer> joinTeam(String teamId, int roleId){
        GlobalResource.getTeamList().get(teamId).getRoleList().add(roleId);
    ...
    public static void startDungeons (String teamId, int roleId){
        ...
        bossAttackRole(teamId,team.getDungeonsId(), GlobalResource.getRoleHashMap().get(roleId).getNowScenesId());
    }
