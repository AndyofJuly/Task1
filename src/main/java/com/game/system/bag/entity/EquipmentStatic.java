...
public class EquipmentStatic {
    ...
    public EquipmentStatic(Integer id, String name, Integer atk, Integer durability, Integer price, Integer level, Integer addHp, Integer addMp, Integer type,Integer quality,Integer addDef) {
        this.id = id;
        this.name = name;
        this.atk = atk;
